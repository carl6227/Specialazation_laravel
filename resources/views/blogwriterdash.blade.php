            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="row" style="height:800px">
                                                        ...
                                                        <div class="projcard-textbox">
                                                            ...
                                                            <div class="projcard-tagbox">
                                                                ...
                                                                <span class="projcard-tag">Likes</span> <a
                                                                    href="/p/{{$post->id}}"><span> <button
                                                                            class="btn btn-sm btn-secondary">read more</button>
                                                                    </span> </a>
                    ...
                    <div class="col-sm-4 border-left border-gray">
                        ...
                        <div class="d-flex">
                            <a href="/profile/{{$blogwriter->id}}"><h5 >{{$blogwriter->username}}</h5></a>
                       </div>
                       @endforeach
                        </div>
                    </div>
         ...
         $.ajax({
             ...
             success: function(res){
                ...
                $.each(res,function(index,value){
                 filterData=  ' <a href="/profile/{{$blogwriter->id}}"><h5>'+value.username+'</h5></a>'
